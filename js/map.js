...
(function () {
  ...
  */
  ...
  var onLoad = function (data) {
    ...
    // Для отображения случайных объявлений порядок элементов в массиве 'перемешивается'
    ads = window.util.mixArray(data.slice());

    // Создает массив элементов 'Метка объявления' на основе массива объявлений.
    pins = window.pin.create(ads, PINS_AMOUNT_MAX);
